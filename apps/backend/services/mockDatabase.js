...
class MockDatabase {
  ...
  handleUpdate(sql, params) {
    ...
    if (sqlLower.includes('cars') && sqlLower.includes('set') && sqlLower.includes('name')) {
      ...
      const [name, brand, year, seats, fuel_type, price_per_day, image_url, location, id] = params;
