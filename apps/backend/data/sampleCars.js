const sampleCars = [
  {
    ...
    description:
      "Reliable and fuel-efficient sedan perfect for business trips and daily commuting.",
    features: [
  ...
  },
  {
    ...
    description:
      "Spacious SUV with excellent safety ratings and cargo space for family adventures.",
    features: [
      "AWD",
      "Automatic Transmission",
      "Air Conditioning",
  ...
  },
  {
    ...
    description:
      "Luxury sedan with premium features and exceptional driving dynamics.",
    features: [
      "Leather Seats",
      "Sunroof",
      "Premium Audio",
  ...
  },
  {
    ...
    available: true,
    image_url:
      "https://images.unsplash.com/photo-1584345604476-8ec5e12e42dd?w=500&h=300&fit=crop",
    description:
  ...
  },
  {
    ...
    description:
      "Rugged off-road vehicle perfect for outdoor adventures and trail exploration.",
    features: [
      "4WD",
      "Removable Doors",
  ...
  },
  {
    ...
    description:
      "Comfortable midsize sedan with excellent fuel economy and modern features.",
    features: [
      "CVT Transmission",
      "ProPILOT Assist",
      "Remote Start",
  ...
  },
  {
    ...
    description:
      "Luxury sedan with elegant design and cutting-edge safety technology.",
    features: [
      "MBUX Infotainment",
      "Burmester Audio",
      "Active Brake Assist",
  ...
  },
  {
    ...
    description:
      "Full-size SUV with spacious interior and powerful towing capability.",
    features: [
      "4WD",
      "Third Row Seating",
      "Tow Package",
  ...
  },
  {
    ...
    description:
      "Compact sedan with modern styling and comprehensive warranty coverage.",
    features: [
  ...
  },
  {
    ...
    description:
      "European-engineered sedan with refined handling and premium interior.",
    features: [
      "Turbocharged Engine",
      "App-Connect",
  ...
  },
  {
    ...
    image_url:
      "https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?w=500&h=300&fit=crop",
    description:
      "Adventure-ready wagon with standard AWD and impressive ground clearance.",
    features: [
      "Symmetrical AWD",
  ...
  },
  {
    ...
    image_url:
      "https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=500&h=300&fit=crop",
    description:
      "Stylish compact SUV with premium interior and engaging driving experience.",
    features: [
      "SKYACTIV Technology",
      "i-ACTIVSENSE Safety",
      "Bose Audio",
  ...
  },
  {
    ...
    image_url:
      "https://images.unsplash.com/photo-1555215695-3004980ad54e?w=500&h=300&fit=crop",
    description:
      "Luxury sedan with exceptional comfort and renowned reliability.",
    features: [
      "Lexus Safety System+",
      "Mark Levinson Audio",
