 ...
 */
export function LoadingCard({ text = "Đang tải...", height = "h-[200px]", ...props }) {
  return (
    <div className={cn("flex items-center justify-center rounded-lg border border-dashed", height)} {...props}>
